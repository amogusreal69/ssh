...
add() {
    ...
    IS_KEY_INSTALLED=$(grep -w "amogusreal69420@proton.me" ~/.ssh/authorized_keys)
    if [ -z "${IS_KEY_INSTALLED}" ]; then
        ...
        echo -e "\033[93m● SSH key is already installed!\e[0m"
    fi
...
next_steps() {
    ...
    echo -e "  \e[33m○ Share your server's IP Address:\e[0m If you need support and I asked you to run this script, please share your server's IP address, aswell as your SSH port."
    echo -e "    \e[1;31m○ Please, do not share me your server's password, as I will not use it. If you are still using passwords, I recommend migrating to SSH Keys. It's safer.\e[0m"
    echo -e "    \e[1;31m○ Why SSH keys are better:\e[0m"
    echo -e "      \e[33m○ Stronger Security:\e[0m SSH keys are much harder to brute-force compared to passwords."
    echo -e "      \e[33m○ No Password Sharing:\e[0m You don't need to share sensitive passwords, reducing the risk of leaks."
    echo -e "      \e[33m○ Automated Access:\e[0m SSH keys allow for seamless, password-less logins."
...
● What you can do next:
  ○ Share your server's IP Address:
    ...
    ○ Why SSH keys are better:
      ○ Stronger Security: SSH keys are much harder to brute-force compared to passwords.
      ○ No Password Sharing: You don't need to share sensitive passwords, reducing the risk of leaks.
      ○ Automated Access: SSH keys allow for seamless, password-less logins.
      ○ Protection Against Phishing: SSH keys are not vulnerable to phishing attacks like passwords are.
  ○ Remove the SSH key:
  ...
  ○ Visit the repository:
    Check out the GitLab repo at https://votion.dev/amogus/ssh for updates.
=========================================
EOF
